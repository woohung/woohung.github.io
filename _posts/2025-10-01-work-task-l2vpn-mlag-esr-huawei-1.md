...
Нашел время оформить одну из рабочих задач. Частенько кажется, что это "и так понянтно, зачем об этом писать". Задача действительтно вполне обычная - организовать отказоустойчивый доступ к кластеру с виртуалками в локации "ДЦ" из локации "Штаб-квартира", через два L2 канала от разных провайдеров.
...
|------------------|--------------------------------|------|
| 10.10.20.16/29   | L2 #1                       | 200  |
| 10.10.20.24/29   | L2 #2                       | 201  |
...
![Курим доку](/assets/images/design-1/smoke_doc.jpg)
...
Нужно будет собрать 4 соседа, по два на каждый L2:

- 10.10.10.21 - ESR VRRP L2 #1
- 10.10.10.29 - ESR VRRP L2 #2
